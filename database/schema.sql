-- IDF Proxy Manager - Database Schema
-- PostgreSQL 15+
...
-- GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO idf_app;
-- GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO idf_app;
